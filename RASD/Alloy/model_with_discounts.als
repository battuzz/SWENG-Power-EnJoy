...
sig Ride {
	...
	/* This ride was well populated iff at least 70% of the samples have 3 people */
	/* enoughPassengers <=> (#intermediatePosition.numPeople... */
}
...
/* Every event is associated to at most one ride */
/*fact DifferentEventsPerRides {
	all disj r1, r2 : Ride | no (r1.event & r2.event)
}*/

/* A user can't make two reservations at the same time */
/*fact NoReservationAtSameTimeFromSameUser { 
	all disj r1, r2 : Reservation, ru : RegisteredUser | (r1 in ru.reservations and r2 in ru.reservations) implies r1.timestamp != r2.timestamp
}*/
...
run show for 6 but exactly 2 Ride

//run unlockCar for 6 but exactly 2 Ride, 1 RegisteredUser, 2 Reservation, 2 Sample, 1 Car
